...
program_version_link="https://raw.githubusercontent.com/caidewu/frps/master/version.sh"
str_install_shell=https://raw.githubusercontent.com/caidewu/frps/master/install.sh
shell_update(){
    fun_clangcn "clear"
